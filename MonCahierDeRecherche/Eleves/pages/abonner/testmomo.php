<?php
 ...
 $con = mysqli_connect("localhost","root","","eclasse");
 ...
 if(isset($_POST['paye'])){
    ...
    $id= $_GET["id"];
    if(strlen($num)==10){
        $que = "INSERT INTO `payement`(`user_id`,`choix_ab`,`numero` ) VALUES ('$id','$choix','$num')";
        if( mysqli_query($con,$que)){

        echo' <h3>Payement Reussi !!! <a href="../historique.php">retour</a></h3> ';
        }else{
