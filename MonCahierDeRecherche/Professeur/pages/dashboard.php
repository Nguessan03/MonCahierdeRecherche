            ...
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <td style="text-align:center;">
                        <a href="avatar.jpg"> <img src="avatar.jpg" alt="" height="50px" width="50px"></a>
                    </td>
                    <td>
                        <?php echo $row['niveau']; ?>
                    </td>
                    ...
                    <td style="text-align:center;">
                        <a href="<?=$row['img']?>"> <img src="<?=$row['img']?>" alt="" height="50px" width="50px"></a>
                    </td>
                    <td style="text-align:center;">
                        <a href="<?=$row['img1']?>"> <img src="<?=$row['img1']?>" alt="" height="50px" width="50px"></a>
                    </td>
                    <td>
                       <a href="../change.php?id='<?=$row['id'];?>'"> <button type="button" name="update" data-name="'.$name.'" 
                    ...
                    <td>
                        <a href="">
                            <button type="button" name="delete" data-name="'.$name.'" 
                        class="update btn btn-warning btn-xs">
                           supprimer
                        </button>
                        </a>
